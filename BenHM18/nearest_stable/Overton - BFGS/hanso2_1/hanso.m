function [x, f, loc, X, G, w, H, erec, trec] = hanso(pars, options)
%  HANSO: Hybrid Algorithm for Nonsmooth Optimization, Version 2.1
...
%   Version 2.1, 2015, see GPL license info below.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  HANSO 2.1 Copyright (C) 2015  Michael Overton
...
if prtlevel > 0  
    fprintf('HANSO Version 2.1, optimizing objective %s over %d variables with options\n', ...
        pars.fgname, pars.nvar')
    disp(options)
end
% BFGS phase with possibly multiple starting points (10 if not provided by user)
[x, f, d, H, iter, info, X, G, w, ~, erec, trec] = bfgs(pars, options); 
